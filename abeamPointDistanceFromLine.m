function [Track_computed_y, method] = abeamPointDistanceFromLine(seg_x,seg_y,...
                                                         ref_x,track_id,...
                                                         useExtrapolation)
%% This function computes the abeam distance from each point of the given
% vector of [x,y] coordinates to the given reference path points
% the reference path 
%% initialize
